...
export default function CustomersPage() {
  ...
  useEffect(() => {
    ...
    // Verificar si viene con parámetro para crear cliente
  ...
  const handleDeactivate = async (customerId: number) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        setError('Ocurrió un error al desactivar el cliente.');
      }
    }
  };
  ...
  const handleActivate = async (customerId: number) => {
    try {
      ...
      if (err instanceof Error) {
        ...
        setError('Ocurrió un error al activar el cliente.');
      }
    }
  };
  ...
  const handleEditCustomer = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        setError('Ocurrió un error al editar el cliente.');
      }
    } finally {
      setFormLoading(false);
    }
                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <input
                            ...
                            value={address.state || ''}
                            onChange={(e) => updateCreateAddress(index, 'state', e.target.value)}
                            className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                          />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <input
                            ...
                            onChange={(e) => updateCreateAddress(index, 'zipCode', e.target.value)}
                            className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                          />
                          <input
                            type="text"
                        ...
                        <div>
                          <input
                            ...
                            value={address.notes || ''}
                            onChange={(e) => updateCreateAddress(index, 'notes', e.target.value)}
                            className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                          />
                        </div>
                      </div>
                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <input
                            ...
                            placeholder="Estado/Provincia"
                            value={address.state || ''}
                            onChange={(e) => updateEditAddress(index, 'state', e.target.value)}
                            className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                          />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <input
                            ...
                            placeholder="Código Postal"
                            value={address.zipCode || ''}
                            onChange={(e) => updateEditAddress(index, 'zipCode', e.target.value)}
                            className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                          />
                          <input
                            type="text"
                        ...
                        <div>
                          <input
                            ...
                            placeholder="Notas adicionales (opcional)"
                            value={address.notes || ''}
                            onChange={(e) => updateEditAddress(index, 'notes', e.target.value)}
                            className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                          />
                        </div>
                      </div>
